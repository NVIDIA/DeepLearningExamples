...
# This script launches UNet training benchmark in FP32/TF32 on 4 GPUs using 16 batch size (4 per GPU)
# Usage ./UNet_trainbench_4GPU.sh <path to dataset> <dagm classID (1-10)>
