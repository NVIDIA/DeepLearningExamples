...
mkdir -p /tmp/training-benchmark-AMP-A100-80G
rm -rf /tmp/training-benchmark-AMP-A100-80G/*
...
--model_dir=/tmp/training-benchmark-AMP-A100-80G \
...
2>&1 | tee /tmp/training-benchmark-AMP-A100-80G/train-benchmark.log