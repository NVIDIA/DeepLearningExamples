...
mkdir -p /tmp/training-benchmark-FP32-V100-32G
rm -rf /tmp/training-benchmark-FP32-V100-32G/*
...
--model_dir=/tmp/training-benchmark-FP32-V100-32G  \
...
2>&1 | tee /tmp/training-benchmark-FP32-V100-32G/train-benchmark.log