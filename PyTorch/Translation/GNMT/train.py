...
def parse_args():
    ...
    training.add_argument('--train-iter-size', default=1, type=int,
    ...
    training.add_argument('--batching', default='sharding', type=str,
    ...
    val.add_argument('--val-batch-size', default=128, type=int,
                     help='batch size for validation')
    val.add_argument('--max-length-val', default=80, type=int,
...
def main():
    ...
    distributed = utils.init_distributed(args)
